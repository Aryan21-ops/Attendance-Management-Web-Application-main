          ...
          >
            ...
            >
              <Box m="20px 100px 0 100px">
                ...
                >
                  <p style={paraStyles}>
                    Welcome to DocDash, your go-to solution for streamlined
                    Document management. Here's a glimpse into who we are and
                    what we stand for:
                  </p>

                  <p style={paraStyles}>
                    At DocDash, we understand the complexities that come with
                    managing documents in organizations of all sizes. That's
                    why we've crafted a user-friendly web application aimed at
                    simplifying this process and empowering businesses to
                    efficiently track and manage documents.
                  </p>

                  <p style={paraStyles}>
                    Our mission is to provide organizations with a reliable,
                    secure, and intuitive platform that enhances their
                    Document management workflows. With DocDash, you can say
